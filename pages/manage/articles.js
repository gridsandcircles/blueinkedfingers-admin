...
const ManageArticles = () => {
  ...
  const getArticles = async () => {
    const articlesRef = collection(fireDb, "articles");
                ...
                >
                  ...
                  <div className={"mt-2 space-y-1"}>
                    ...
                    <div className={"flex items-center gap-2"}>
                      ...
                      <button
                      onClick={() => {
                        if (confirm("Are you sure you want to delete this article? This action is not reversible!"))  {
                          const blogDocRef = doc(fireDb, "articles", article.id)
                          deleteDoc(blogDocRef).then(() => {
